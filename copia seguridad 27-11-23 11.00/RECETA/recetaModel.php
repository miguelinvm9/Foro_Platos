...
require 'conectaDatabase.php';
    ...
    function actualizarReceta($id, $nombre, $tiempo, $dificultad, $texto, $fecha, $id_usuario) {
        global $conexion;
		$sql = "UPDATE receta SET nombre = :nombre, tiempo = :tiempo, dificultad = :dificultad, texto = :texto, fecha = :fecha, id_usuario = :id_usuario WHERE id = :id";
        $stmt = $conexion->prepare($sql);
